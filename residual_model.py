...
def create_resnet_intermediate(input_shape,
                  num_classes=10,
                  block='bottleneck',
                  repetitions=None,
                  initial_filters=64,
    ...
    model = tf.keras.models.Model(img_input, [intermediate, x])
    return model


def create_resnet8(input_shape,
                    num_classes,
                    norm='group',
                    seed: Optional[int] = None):
...
def create_resnet18_intermediate(input_shape,
                    num_classes,
                    norm='group',
                    seed: Optional[int] = None):
    """ResNet with 18 layers and basic residual blocks."""
    return create_resnet_intermediate(
        input_shape,
        num_classes,
        'basic',
        repetitions=[2, 2, 2, 2],
